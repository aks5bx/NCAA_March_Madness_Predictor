...
def see32(mid, east, west, south):
    ...
    print(roundof64(mid))
    print('----------------------------------------')
    print(roundof64(east))
    print('----------------------------------------')
    print(roundof64(west))
    print('----------------------------------------')
    print(roundof64(south))
...
def see16(mid, east, west, south):
    ...
    print(roundof32(mid))
    print('----------------------------------------')
    print(roundof32(east))
    print('----------------------------------------')
    print(roundof32(west))
    print('----------------------------------------')
    print(roundof32(south))    
...
def see8(mid, east, west, south):
    ...
    print(roundof16(mid))
    print('----------------------------------------------------')
    print(roundof16(east))
    print('----------------------------------------------------')
    print(roundof16(west))
    print('----------------------------------------------------')
    print(roundof16(south))  
    
def see4(mid, east, west, south):
    print('######################################################################')
    print('FINAL FOUR')
    print(elite8(mid)['Team'])
    print('----------------------------------------------------')
    print(elite8(east)['Team'])
    print('----------------------------------------------------')
    print(elite8(west)['Team'])
    print('----------------------------------------------------')
    print(elite8(south)['Team'])  
